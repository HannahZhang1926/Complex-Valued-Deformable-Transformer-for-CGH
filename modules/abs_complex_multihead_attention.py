...
class AbsComplexMultiheadAttention(nn.Module):
    ...
    def forward(self, query, key, value, attn_mask=None):
        ...
        attn_weights = torch.abs(torch.bmm(q, torch.conj(k.transpose(1, 2))))
        ...
        attn = torch.bmm(torch.complex(attn_weights, attn_weights.new_zeros(attn_weights.shape)), v)
