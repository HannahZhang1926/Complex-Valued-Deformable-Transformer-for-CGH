...
class AbsPhaseComplexMultiheadAttention(nn.Module):
    ...
    def forward(self, query, key, value, attn_mask=None):
        ...
        attn_weights = torch.abs(qk_inner)
        ...
        attn_sgn = qk_inner / torch.abs(qk_inner)
        attn_weights = attn_weights * attn_sgn
        
        attn_weights.real, attn_weights.imag = self.attn_dropout(attn_weights.real, attn_weights.imag)
